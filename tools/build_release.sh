...
rm -Rf $TMP_DIR/wp2static-addon-gcs
mkdir $TMP_DIR/wp2static-addon-gcs
...
cp -r $EXEC_DIR/*.php $TMP_DIR/wp2static-addon-gcs/
cp -r $EXEC_DIR/src $TMP_DIR/wp2static-addon-gcs/
cp -r $EXEC_DIR/vendor $TMP_DIR/wp2static-addon-gcs/
cp -r $EXEC_DIR/views $TMP_DIR/wp2static-addon-gcs/
...
zip --quiet -r -9 ./$1.zip ./wp2static-addon-gcs
